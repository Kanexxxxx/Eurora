    ...
    <main className="relative min-h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <motion.div
          ...
          className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-rose-600/20 rounded-full blur-[140px]"
        />
      </div>
      ...
      <section className="relative px-4 py-14 sm:py-20">
        <div className="max-w-2xl mx-auto">
          ...
          >
            <div className="relative w-24 h-24 sm:w-28 sm:h-28 rounded-full bg-gradient-to-br from-rose-500 via-pink-400 to-amber-400 flex items-center justify-center shadow-[0_0_80px_rgba(255,45,106,0.6)]">
          ...
          >
            ...
            <div className="flex items-center justify-between gap-3">
              <p className="text-rose-300 font-medium break-all text-xs sm:text-sm font-mono-romantic">
                {pageUrl}
              </p>
              <button
                onClick={copy}
          ...
          >
            ...
            <button
              onClick={shareNative}
              className="py-3.5 rounded-2xl bg-gradient-to-r from-fuchsia-500 to-rose-500 text-white text-sm font-semibold shadow-[0_8px_30px_-8px_rgba(244,114,182,0.5)] hover:scale-[1.02] active:scale-[0.98] transition-transform"
            >
              📲 Compartilhar
            </button>
            <Link
              href={`/${slug}`}
              className="py-3.5 rounded-2xl bg-gradient-to-r from-rose-500 to-rose-600 text-white text-sm font-semibold shadow-[0_8px_30px_-8px_rgba(255,45,106,0.5)] hover:scale-[1.02] active:scale-[0.98] transition-transform text-center"
            >
              💖 Ver página
            </Link>
            <a
          ...
          >
            ...
            <div className="relative inline-block">
              <div className="absolute inset-0 bg-gradient-to-br from-rose-500/30 to-amber-400/30 blur-2xl rounded-3xl" />
