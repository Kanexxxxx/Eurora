        ...
        <div className="mx-auto max-w-7xl px-4">
          ...
          >
              ...
              {NAV.map((item) => {
                ...
                return (
                  ...
                  >
                    ...
                    {item.badge && (
                      <span className="ml-1.5 inline-flex items-center px-1.5 py-0.5 text-[9px] font-bold uppercase tracking-wider bg-rose-500 text-white rounded-full">
                        {item.badge}
                      </span>
                    )}
                  </Link>
            ...
            <div className="hidden sm:flex items-center gap-2">
              <Link
                href="/criar"
                className="relative inline-flex items-center gap-2 px-5 py-2.5 rounded-full text-sm font-semibold text-white bg-gradient-to-r from-rose-500 to-rose-600 shadow-[0_8px_30px_-8px_rgba(255,45,106,0.7)] hover:shadow-[0_12px_40px_-8px_rgba(255,45,106,0.9)] hover:scale-[1.02] transition-all duration-300"
              >
